...
{
	[Activity (Label = "UniqueAdapter")]		

	public class UniqueAdapter : BaseExpandableListAdapter
	{
		//Activity context;
		//ExpandableListView lv;

		protected List<Grouping<string,itu>> items { get; set; }
		protected List<Grouping<string,itu>> filteredItems { get; set; }


		public UniqueAdapter(ObservableCollection<Grouping< string,itu>> items)
		{
			//this.context = context;

			this.items = new List<Grouping<string,itu>>(items);
			this.filteredItems = new List<Grouping<string,itu>>(items);
		...
		public void filterList(String search) {
			...
			filteredItems = new List<Grouping<string,itu>>();
			foreach (Grouping<string,itu> item in items) {
				if (item.isNF == true) {
...
//				if (items [groupPosition].isNF == true) {
