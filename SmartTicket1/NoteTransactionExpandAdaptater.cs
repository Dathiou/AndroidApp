...
{
	[Activity (Label = "NoteTransactionExpandAdaptater")]		

	public class NoteTransactionExpandAdaptater : BaseExpandableListAdapter
	{
		//Activity context;
		//ExpandableListView lv;

		List<Grouping<string,itu>> items { get; set; }

		public NoteTransactionExpandAdaptater(ObservableCollection<Grouping< string,itu>> items)
		{
		...
		public override View GetGroupView(int groupPosition, bool isExpanded, View convertView, ViewGroup parent)
		{
			...
			//addButton.Image = "ic_card_travel_white_24dp.jpg";
			addButton.Click += async (sender, e) => {
				...
				gameScore["IsNote"] = false;
					Toast.MakeText(Android.App.Application.Context, "Retiré de note de frais", ToastLength.Short).Show();
